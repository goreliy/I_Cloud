@echo off
chcp 65001 > nul
title Средний стресс-тест

echo ============================================================
echo   СРЕДНИЙ СТРЕСС-ТЕСТ
echo ============================================================
echo   Параметры: 10 workers, 100 RPS, 60 секунд
echo   Примерно 6,000 запросов
echo ============================================================
echo.
...
python tests/stress_test.py --api-key %API_KEY% --workers 10 --rps 100 --duration 60
